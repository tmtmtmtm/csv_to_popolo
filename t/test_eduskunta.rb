...
describe 'eduskunta' do
  ...
  let(:amms) { mems.find_all { |m| m[:person_id] == 'person/104' } }
  ...
  it 'should have legislative membership' do
    pm = amms.find_all { |m| m[:organization_id] == 'legislature' }
  ...
  it 'should have legislative Organization' do
    orgs.find_all { |o| o[:classification] == 'legislature' }.size.must_equal 1
  end

  it 'should have no executive Organization' do
    orgs.find_all { |o| o[:classification] == 'executive' }.size.must_equal 0
  end
